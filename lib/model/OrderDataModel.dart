...
class OrderDataModel {
    ...
    OrderDataModel({this.amount, this.app_user_id, this.bank, this.bank_id, this.create_time, this.has_pay, this.id, this.image, this.is_admin, this.is_delete, this.order_no, this.parent_id, this.real_amount, this.remark, this.service_id, this.status, this.trans_type, this.type});

    factory OrderDataModel.fromJson(Map<String, dynamic> json) {
        return OrderDataModel(
            amount: json['amount'], 
            app_user_id: json['app_user_id'], 
            bank: json['bank'] != null ? BankItemModel.fromJson(json['bank']) : null,
