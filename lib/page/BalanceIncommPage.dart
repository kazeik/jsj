...
class BalanceIncommPage extends StatefulWidget {
  final List<BalanceDataModel> allData;

  BalanceIncommPage({Key key, this.allData}) : super(key: key);

  @override
  State<StatefulWidget> createState() => new _BalanceIncommPageState();
}

class _BalanceIncommPageState extends State<BalanceIncommPage> {
  @override
